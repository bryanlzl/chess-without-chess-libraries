...
Fully written from scratch WITHOUT REFERENCE to chess engines, utilizing numpy array as the chessboard with integers representing individual pieces, chess board in white's perspective. Once the game is concluded, player is brought to main menu after 3 seconds
