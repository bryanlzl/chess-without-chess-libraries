import game_modes.chess_vs_human as chh
import game_modes.chess_vs_ai as cha
import numpy as np
import pygame as pg
import sys
...
def popup1p():
    ...
    MSCREEN.blit(readyfont2.render('BOT plays', True, (0, 0, 0)), (354, 436))
    MSCREEN.blit(readyfont2.render('WHITE', True, (0, 0, 0)), (375, 460))
    MSCREEN.blit(readyfont2.render('BOT plays', True, (0, 0, 0)), (354, 505))
...
def clickhighlights(playerselected, aiselected, turnselected): # Highlights the selected buttons in light green
    ...
    if playerselected == 1: # Highlight buttons for one player option
        if aiselected == 0:
            ...
            pg.draw.rect(MSCREEN, LIGHTGREEN, ailevel2, 5)
            if turnselected == 0:
                pg.draw.rect(MSCREEN, LIGHTGREEN, aiturnselect0, 5)
            elif turnselected == 1:
                pg.draw.rect(MSCREEN, LIGHTGREEN, aiturnselect1, 5)
